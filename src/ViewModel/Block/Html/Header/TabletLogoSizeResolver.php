 ...
 */
class TabletLogoSizeResolver implements LogoSizeResolverInterface, ArgumentInterface
{
    /** @var Stores */
    ...
    {
        return $this->storesHelper->getStoreConfig('design/header/tablet_logo_width');
    }

    public function getHeight(?int $storeId = null): ?int
    {
        return $this->storesHelper->getStoreConfig('design/header/tablet_logo_height');
    }
}
