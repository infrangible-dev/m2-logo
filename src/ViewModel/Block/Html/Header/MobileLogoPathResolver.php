 ...
 */
class MobileLogoPathResolver implements LogoPathResolverInterface, ArgumentInterface
{
    /** @var Stores */
    ...
    public function getPath(): ?string
    {
        ...
        $storeLogoPath = $this->storesHelper->getStoreConfig('design/header/mobile_logo_src');
